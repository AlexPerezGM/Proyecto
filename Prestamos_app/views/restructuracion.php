    ...
    <div class="sidebar-inner">
      ...
      <div class="sidebar-section">
        ...
        <a class="nav-link" href="<?= $APP_BASE ?>views/clientes.php">
          <span class="nav-icon">👥</span><span class="nav-text">Gestión de Clientes</span>
        </a>

        <a class="nav-link" href="<?= $APP_BASE ?>views/prestamos.php">
          <span class="nav-icon">📄</span><span class="nav-text">Control de Préstamos</span>
        </a>

        <a class="nav-link" href="<?= $APP_BASE ?>views/pagos.php">
          <span class="nav-icon">💳</span><span class="nav-text">Gestión de Pagos</span>
        </a>

        <a class="nav-link" href="<?= $APP_BASE ?>views/seguimiento.php">
          <span class="nav-icon">🧭</span><span class="nav-text">Seguimiento</span>
        </a>

        <a class="nav-link active" href="<?= $APP_BASE ?>views/restructuracion.php">
          <span class="nav-icon">🛠️</span><span class="nav-text">Reestructuración</span>
        </a>
      </div>
    </div>
  </aside>
