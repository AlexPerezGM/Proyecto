...
requiere_login();
require_permission('pagos', 'admin');
  ...
  <aside class="sidebar sidebar-expanded">
    <div class="sidebar-inner">
      ...
      <div class="sidebar-section">
        ...
        <a class="nav-link" href="views/campanas_promocion.php">
          <span class="nav-icon">📅</span>
    ...
    <section class="card">
      ...
      <div class="card-body">
        ...
        <div class="table-wrap" style="margin-top:12px">
          <table id="tablaResultados" class="table table-simple">
            <thead>
              <tr>
    ...
    <div class="modal-content">
      ...
      <form id="frmEfectivo">
        ...
        <div class="modal-body">
          ...
          <input type="number" step="0.01" name="monto" class="input" placeholder="0.00" required>
    ...
    <div class="modal-content">
      ...
      <form id="frmTransfer">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="referencia" class="input" placeholder='' required>
