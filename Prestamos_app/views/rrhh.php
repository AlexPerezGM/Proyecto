  ...
  <aside class="sidebar sidebar-expanded">
    <div class="sidebar-inner">
      ...
      <div class="sidebar-section">
        ...
        <a class="nav-link" href="<?= $APP_BASE ?>views/seguimiento.php"><span class="nav-icon">📈</span><span class="nav-text">Seguimiento</span></a>
        <a class="nav-link active" href="<?= $APP_BASE ?>views/rrhh.php"><span class="nav-icon">🏢</span><span class="nav-text">Recursos Humanos</span></a>
      </div>
    </div>
  </aside>
