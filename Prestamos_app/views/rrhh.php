    ...
    <div class="modal__body">
      <form id="frmEmpleado">
        ...
        <div class ="modal__content">
          <h4 style="font-size: 20px;">Aplicar beneficios y deducciones extra</h4>
          <div class="card">
            <div class="card-header">
              Ajustes vigentes
              <button class="btn btn-sm" id="btnNuevoAjuste" style="float:right;">Nuevo ajuste</button>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table id="tablaAjustes" class="table-simple">
                  <thead>
                    <tr>
                      <th>Tipo</th>
                      <th>Nombre</th>
              ...
              <div id="errorAjustesList" class="error-box" hidden></div>
            </div>
          </div>
        </div>
      ...
      <form id="frmAjuste">
        ...
        <div class="grid-2">
          ...
          <div>
            ...
            <select class="input" name="id_catalogo" id="ajuste_id_catalogo" required disabled></select>
          </div>
        </div>
        ...
        <div class="modal__footer">
          <button class="btn" type="submit" style="font-size: 16px;">Guardar ajuste</button>
