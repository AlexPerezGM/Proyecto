...
function buildCalendar(container, eventos, yearInput = null, monthInput = null) {
    const now = new Date();

    let year = yearInput !== null ? yearInput : now.getFullYear();
    let month = monthInput !== null ? monthInput : now.getMonth();
    ...
    btnPrev.addEventListener("click", () => {
        ...
        buildCalendar(container, eventos, newYear, newMonth);
    });
    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        if (eventosDia && eventosDia.length > 0) {
            ...
            let estadoPrincipal = "pagada";
            let icono = "🟢";
            if (counts.vencida > 0) {
                estadoPrincipal = "vencida";
                icono = "🔴";
            } else if (counts.pendiente > 0) {
            ...
            summaryBtn.innerHTML = `
                ...
                <span class="summary-badges">
                    <span class="badge badge-${estadoPrincipal}">
                    ${total} ${icono}
                    </span>
                </span>
            `;
